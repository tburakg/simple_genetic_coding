...
class Genetic:
    def __init__(self, Target, Population_Number):
        self.Gene_Pool = '''abcçdefgğhıijklmnoöprsştuüvwxyzABCÇDEFGĞHİIJKLMNOÖPRSŞTUÜVWXYZ 1234567890,.-;:_!"#%$/()=?@&{[]}'''
        self.Target = Target
    ...
    def main(self):
        ...
        print(f"you found = {self.Found_Text}\n You did it {self.Generation_Timer} steps."
